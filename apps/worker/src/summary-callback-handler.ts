      ...
      if (error instanceof SummaryAccessError) {
        ...
        if (error.code === 'LEFT_CHAT') {
          text = error.homeTitle
            ? `Вы больше не состоите в домовом чате «${error.homeTitle}». Доступ к сводкам и уведомлениям сервиса «Тихий Чат» приостановлен. Чтобы возобновить доступ, вступите в домовой чат.`
            : 'Вы больше не состоите в домовом чате. Доступ к сводкам и уведомлениям сервиса «Тихий Чат» приостановлен. Чтобы возобновить доступ, вступите в домовой чат.';
        }
        const directUrl = this.options.getUserDirectUrl?.(user.user_id);
