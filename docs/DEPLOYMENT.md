...
- Reserved address: `quiet-chat-public-ip` (`81.26.184.200`, detached) and `quiet-chat-public-ip-active` (`158.160.226.198`, reserved static address with deletion protection); active hostname `158-160-226-198.sslip.io` configured with automated Let's Encrypt TLS.
