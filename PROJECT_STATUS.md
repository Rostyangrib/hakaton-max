...
- [x] Проверено резервное копирование в Object Storage (`quiet-chat-backups-b1ge00tftjithijbde7u`) и плановая очистка retention.
- [ ] Зарегистрировать Webhook URL и Mini App URL в настройках бота MAX.
...
Добавлены корневые сертификаты Минцифры России в `deploy/certs/`, обновлена конфигурация `compose.production.yaml` и актуализирован статус проекта.
 
## Следующий конкретный шаг
 
Зарегистрировать webhook MAX и Mini App URL в настройках бота:
- Webhook URL: `https://158-160-237-183.sslip.io/webhooks/max`
- Webhook Secret: значение из Lockbox
- Mini App URL: `https://158-160-237-183.sslip.io`
Затем провести сквозные тесты: `/start`, сохранение профиля жильца, генерация сводки и алерта.
