...
**Этап 5 — развёртывание и безопасность: в работе, VM подготовлена и ожидает production-секреты.**
...
- [ ] Завершить проверку входящей доступности HTTPS и регистрацию MAX webhook.
...
## Незакоммиченные изменения
 ...
 В репозиторий внесены доработки сервиса деплоя, production Dockerfile (npmmirror) и актуализация статуса развёртывания.
 
 ## Следующий конкретный шаг
 
 Завершить проверку входящего трафика к Caddy/API на ВМ, зарегистрировать MAX webhook и провести сквозные тесты бота.
